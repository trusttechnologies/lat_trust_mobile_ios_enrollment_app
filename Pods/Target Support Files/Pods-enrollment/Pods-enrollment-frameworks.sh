...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Audit/Audit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MaterialComponents-10e119f4/MaterialComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ObjectMapper/ObjectMapper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Protobuf/Protobuf.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Realm/Realm.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RealmSwift/RealmSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TrustDeviceInfo/TrustDeviceInfo.framework"
